  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System - Streamlining Your Workforce Management. Effortlessly Manage Employee Data, Vacations, and Payroll in One Place."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System - Streamlining Your Workforce Management. Effortlessly Manage Employee Data, Vacations, and Payroll in One Place.`}
            </Text>
            <Box
